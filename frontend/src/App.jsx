...
const ScrollTopButton = ({ threshold = 200, showOnMount = false }) => {
  ...
  return (
    <button
      onClick={scrollToTop}
      className="fixed right-6 bottom-6 z-50 p-2 rounded-full focus:outline-none focus:ring-sky-300 backdrop-blur-sm border-white/20 shadow-lg cursor-pointer transition-transform"
    >
