...
import { BadgeCent, BadgeCheck, Star, ShieldUser, MessageCircleCode } from 'lucide-react'
            ...
            <section className={aboutUsStyles.heroSection}>
                <div className={aboutUsStyles.heroBackground}>
                    <div style={{ backgroundImage: `url(${AboutBanner})`, opacity: 0.85 }} className={aboutUsStyles.heroImageContainer}>
                        <div className={aboutUsStyles.heroVignette} style={{ background: "linear-gradient(to bottom, rgba(0,0,0,0.72) 0%, rgba(0,0,0,0.0) 30%, rgba(0,0,0,0.0) 70%, rgba(0,0,0,0.72) 100%)", }} />
                    </div>
                ...
                <div className={aboutUsStyles.heroContent}>
                    ...
                    <h1 className={aboutUsStyles.subHeading}>About LearnHub</h1>
                            ...
                            <div className={`${aboutUsStyles.sectionContent} ${index % 2 === 1 ? "lg:col-start-1 lg:row-start-1" : ""}`}>
                                ...
                                <div className={aboutUsStyles.featuresContainer}>
                                    {section.features.map((feature, featureIndex) => (
                                        <div className={aboutUsStyles.featureItem} key={featureIndex}>
                    ...
                    <div className={aboutUsStyles.teamGrid}>
                        {teamMembers.map((member, index) => (
                            <div key={index} className={aboutUsStyles.teamMember}>
                                ...
                                <h3 className={aboutUsStyles.teamMember}>{member.name}</h3>
            ...
            <section className={aboutUsStyles.ctaSection}>
                ...
                <div className={aboutUsStyles.ctaContent}>
                    ...
                    <p className={aboutUsStyles.ctaDescription}>
                        Join million of learners who have transformed their lives with LearnHub.
                        Start tour journey today with a 7-day free trial.
                    </p>
