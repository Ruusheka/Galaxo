...
import { MessageSquare, MessageSquareQuote, BadgeCheck ,CalendarDays } from 'lucide-react';
                ...
                <div className={testimonialStyles.grid}>
                    {testimonials.map((t,i) => (
                        <div onMouseMove={(e) => onMouseMove(e,cardsRef.current[i],i)} onMouseLeave={() => onMouseLeave(cardsRef.current[i])} key={t.id} className={testimonialStyles.cardWrapper}>
                            ...
                            <article ref={(e1) => (cardsRef.current[i] =e1)} className={testimonialStyles.card} style={{boxShadow:testimonialStyles.cardShadow,}}>
