...
import { Search, BookOpen, User, BadgeIndianRupee, GraduationCap } from 'lucide-react'
                        ...
                        <div key={booking.id} className={bookingsStyles.bookingCard}>
                            <div className={bookingsStyles.studentSection}>
                                ...
                                <div className={bookingsStyles.studentInfo}>
                                    <h2 className={bookingsStyles.studentName}>{booking.studentName}</h2>
                                    <p className={bookingsStyles.purchaseDate}>Purchased on {booking.purchaseDate || "-"}</p>
                                    <p className={bookingsStyles.studentEmail}>{booking.studentEmail}</p>
                                </div>
                            </div>
                            ...
                            <div className={bookingsStyles.statusContainer}>
                                <span className={bookingsStyles.statusLabel}>Status : </span>
