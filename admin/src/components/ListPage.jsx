...
import { Search, BookOpen, Clock, Video, Eye, EyeClosed, Trash2, Star, StarHalf, User } from 'lucide-react';
const ListPage = () => {
        ...
        try {
            ...
            const mapped = arr.map((c) => {
                ...
                return {
                    ...
                    image: finalImage,
                    rating: typeof c.rating === "number" ? c.rating : (c.avgRating || 0),
        ...
        <div className={listStyles.pageContainer}>
            ...
            <div className={listStyles.contentContainer}>
                <div className={listStyles.headerContainer}>
                    <h1 className={listStyles.headerTitle}>Courses catalog</h1>
                    <p className={listStyles.headerSubtitle}>Manage and Browse your Courses - clean, light and elegant.</p>
                </div>
                ...
                <div className={listStyles.searchContainer}>
                    <div className={listStyles.searchInputContainer}>
                        ...
                        <input type="text" placeholder="Search courses..." className={listStyles.searchInput} value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} />
                    </div>
                </div>
                ...
                <div className={listStyles.courseList}>
                                        ...
                                        <div className={listStyles.courseImageContainer}>
                                            ...
                                            <div className={listStyles.courseInfo}>
                                                ...
                                                <div className={listStyles.courseMeta}>
                                                    ...
                                                    <div className={`${listStyles.metaItem} ml-auto`}>
                    ...
                    {!loading && filteredCourses.length === 0 && (
                        <div className={listStyles.emptyState}>
                            ...
                            <p className={listStyles.emptyText}>No course found matching your search..</p>
...
const StarRating = ({ rating }) => {
    ...
    return (
        <div className={listStyles.starRating}>
            ...
            {hasHalf && <StarHalf className={listStyles.starHalf} fill="currentColor" />}
