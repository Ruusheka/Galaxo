...
import { Star, Upload, Plus, Trash2, ChevronDown, ChevronUp, X, Video, Clock, FileText, Layout, DollarSign, Image as ImageIcon, CheckCircle, AlertCircle, BookOpenText, PenLine, UserPen, ListOrdered, BadgeIndianRupee } from "lucide-react";
            ...
            <div className={addPageStyles.contentContainer}>
                <div className={addPageStyles.headerContainer}>
                    <div className={addPageStyles.headerGradient}>
                        ...
                        <p className={addPageStyles.headerSubtitle}>Creaft an exceptional learning experience with our intutive course creation platform</p>
                    </div>
                </div>
                    ...
                    <div className={addPageStyles.modalOverlay}>
                        <div className={addPageStyles.modal}>
                            <div className={addPageStyles.modalHeader}>
                                ...
                                <h2 className={addPageStyles.modalTitle}>Add New Lecture</h2>
                            </div>

                            <div className={addPageStyles.modalContent}>
                                <div>
                                    <label className={addPageStyles.inputLabel}>Lecture Title *</label>
                                    <input type="text" name="title" value={currentLecture.title} onChange={handleLectureChange} placeholder="eg:Introduction to React" className={addPageStyles.input} />
                                </div>
                            </div>
                            ...
                            {currentLecture.chapters.length > 0 && (
                                <div>
                                    <label className={addPageStyles.inputLabel}>Chapters in this lecture : </label>
                            ...
                            <div className='flex gap-2 sm:gap-3 pt-2'>
                                <button type="button" onClick={addLecture} className={`${addPageStyles.modalButton} ${addPageStyles.modalButtonPrimary}`}>Add Lecture</button>
                                <button type="button" onClick={() => setShowLectureForm(false)} className={`${addPageStyles.modalButton} ${addPageStyles.modalButtonSecondary}`}>Cancel</button>
                            </div>
                        </div>
                    </div>
                )}
                        ...
                        <div className={addPageStyles.modal}>
                            ...
                            <div className={addPageStyles.modalContent}>
                                <div>
                                    ...
                                    <input type="text" name="name" value={currentChapter.name} onChange={handleChapterChange} placeholder="e.g., Course Introduction" className={addPageStyles.input} />
                                </div>

                                <div>
                                    <label className={addPageStyles.inputLabel}>Topic *</label>
                                    <input type="text" name="topic" value={currentChapter.topic} onChange={handleChapterChange} placeholder="e.g., What we'll build" className={addPageStyles.input} />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="url" name="videoUrl" value={currentChapter.videoUrl} onChange={handleChapterChange} placeholder="https://youtube.com/watch?v=..." className={addPageStyles.input} />
                                </div>
                            </div>

                            <div className={addPageStyles.modalActions}>
                                <button type="button" onClick={addChapter} className={`${addPageStyles.modalButtonCompact} ${addPageStyles.modalButtonCompactPrimary}`}>Add Chapter</button>
                                <button type="button" onClick={() => { setShowChapterForm(false); setSelectedLectureIndex(null); }} className={`${addPageStyles.modalButtonCompact} ${addPageStyles.modalButtonCompactSecondary}`}>Cancel</button>
                            </div>
                        </div>
                    </div>
                )}
