...
export const dashboardStyles = {
  // Layout styles
  pageContainer: "min-h-screen pt-20 sm:pt-25 bg-gradient-to-br from-gray-50 to-gray-100 font-serif relative",
  ...
  contentContainer: "relative z-10 container mx-auto px-4 sm:px-6 lg:px-12 py-6 sm:py-10",
...
export const listStyles = {
  ...
  contentContainer: "max-w-6xl pt-16 sm:pt-20 lg:pt-25 font-[pacifico] mx-auto",
  ...
  courseBadge: (courseType) =>
    `px-2 py-0.5 mb-4 text-xs font-semibold rounded-full select-none self-start lg:mt-8 xl:mt-8 sm:self-auto ${courseType === 'top'
  ...
  lectureToggleIcon: (isExpanded) =>
    `w-4 h-4 sm:w-5 sm:h-5 text-blue-400 cursor-pointer transition-transform duration-200 flex-shrink-0 ${isExpanded ? 'rotate-180' : ''
    }`,
...
export const addPageStyles = {
  ...
  contentContainer: "max-w-4xl pt-24 sm:pt-30 font-serif mx-auto",
  ...
  courseTypeLabel: (isSelected, type) =>
    `flex items-center gap-2 sm:gap-3 p-3 sm:p-4 border-2 rounded-full cursor-pointer transition-all duration-300 ${isSelected
      ? type === 'top'
  ...
  chaptersContainer: (isExpanded) =>
    `ml-0 sm:ml-10 lg:ml-12 space-y-2 sm:space-y-3 border-l-0 sm:border-l-2 border-purple-200 pl-0 sm:pl-4 lg:pl-6 mt-3 sm:mt-0 ${isExpanded ? 'block' : 'hidden'
    }`,
...
export const navbarStyles = {
  // Main navbar styles
  nav: (isVisible) =>
    `fixed top-6 left-0 right-0 z-50 pointer-events-auto transition-transform duration-500 ease-in-out ${isVisible ? "translate-y-0" : "-translate-y-24"
    }`,
  ...
  desktopNavItem: (isActive) =>
    `relative flex items-center gap-2 cursor-pointer px-4 py-2 rounded-full font-medium transition-all duration-300 transform group overflow-hidden ${isActive
  ...
  mobileMenu: (isMenuOpen) =>
    `md:hidden mt-3 transition-[max-height,opacity,padding] duration-350 ease-in-out overflow-hidden ${isMenuOpen ? 'max-h-60 opacity-100' : 'max-h-0 opacity-0'
    }`,
...
export const bookingsStyles = {
  // Layout styles
  pageContainer: "min-h-screen pt-24 sm:pt-35 bg-sky-50 font-serif p-4 sm:p-6",
  ...
  // Bookings grid
  bookingsGrid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6",
  ...
  detailValue: "ml-2 text-sky-900 break-words flex-1",
